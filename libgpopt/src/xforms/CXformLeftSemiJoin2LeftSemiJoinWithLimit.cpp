...
//
//	@filename:
//		CXformLeftSemiJoin2LeftSemiJoinWithLimit.cpp
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2LeftSemiJoinWithLimit::CXformLeftSemiJoin2LeftSemiJoinWithLimit
//
//	@doc:
//		ctor
//
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2LeftSemiJoinWithLimit::Exfp
//
//	@doc:
...
CXformLeftSemiJoin2LeftSemiJoinWithLimit::Exfp
	...
	const
{
	return CXformUtils::ExfpLeftSemiJoin2LeftSemiJoinWithLimit(exprhdl);
}


//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2LeftSemiJoinWithLimit::Transform
//
//	@doc:
	...
	const
{
	...
	CExpression *pexprJoin = CUtils::PexprLogicalJoin<CLogicalLeftSemiJoin>(pmp, pexprOuter, pexprLimit, pexprScalar);
